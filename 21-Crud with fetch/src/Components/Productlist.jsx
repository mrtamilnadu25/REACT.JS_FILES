...
swalWithBootstrapButtons.fire({
  ...
  let hus=products.filter(product=>product.id !== id)
  setProducts(hus)
}
       ...
       products.map(product=>(
        <section className="hole" key={product.id}>
         ...
         <div className="buttonSpace">
           ...
           <button className="btn1"><FaCartArrowDown style={{color:"green",backgroundColor:'gray', width:"30px",height:"30px",display:"flex",alignItems:"center",justifyContent:"center"}}/>
</button>
